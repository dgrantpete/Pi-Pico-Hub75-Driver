...
// OLD GRADIENT (without peak brightness boost) - kept for reference/revert
// To revert: replace the above BALATRO_GRADIENT with this one
/*
static const uint8_t BALATRO_GRADIENT_OLD[256 * 3] = {
    // 0-85: RED zone
      8, 20, 24,   24, 16, 16,   33, 16, 16,   49, 16, 16,
     57, 16, 16,   66, 16, 16,   82, 16, 16,   90, 16, 16,
    107, 16,  8,  115, 12,  8,  132, 12,  8,  140, 12,  8,
